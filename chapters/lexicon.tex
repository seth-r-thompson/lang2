...
\entry[pos=n., sound=ǫ]{cunvarą}{\sense seagull \sense[\tsc{politics}] columnist, writer (in newspaper, magazine): \rz{cunvarǫzar hazeklam tę nassoin kesaratnik lar orra} “writers critiqued the king's subpar response.” \sense[idiom. arch.] court jester; a traditional storyteller who served as a royal advisor representing the general public \sense[{\bf\rzc satat cunvarą} pej.] feign interest for attention, virtue signal}
\end{dic}
...
\entry[pos=n.,sound=ę]{ennąt}{\sense develop into, become \sense change into (a pair of clothes) \sense move to (another place)}
...
\entry[sound=o,pos=n.]{metka}{\sense rounded semi-circle hollow container; bowl, basket, vessel  \sense measure word for crops or farm animals}
\end{dic}
...
\entry[pos=v. in.,sound=o,etym=\rz{nik} “flat” + \rz{hor} “craft”]{nikhar}{\sense to create a map of \rz{ez} a region}
...
% ===== O =====
\begin{dic}{O}
\entry[pos=adj.,sound=o,note=underlying /ot͡soa/]{oca}{\sense deep \sense (of people) tall and thin, wiry, spindly}
\entry[pos=n.,sound=e]{ocza}{\sense two}
\entry[pos=n., sound=o]{okva}{\sense valley}
...
\entry[pos=n.,sound=o,etym=Classical Cape]{armę́}{\sense ocean}
...
% ===== P =====
\begin{dic}{P}
\entry[pos=n.,sound=e]{pakna}{\sense house, shelter}
...
\entry[pos=n.,sound=e,etym=Old East Cape \fz{raxir} “fish”, note=sometimes spelled {\rz{raxir}, pronounced {[ɹaʃɛɹ]}, in elite circles or when exaggerating}]{rasar}{\sense meat (food) \sense[archaic] fish delicacy}
...
% ===== T =====
\begin{dic}{T}
\entry[pos=v. in.,sound=ę]{tahąt}{\sense stretch (one's limbs) \sense reach for \rz{???} something above oneself \sense aspire to \rz{???} an unreachable goal: \rz{... akakvazi ... oca ...} “he aspired to be a tagplayer, but he wasn't tall enough.” \sense[\sc religion] pray}
