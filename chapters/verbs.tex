...
\paragraph{Speech participants} First-person and second-person agreement suffixes don't require any evidence agreement suffix.\marginnote{-\rz{rci} and -\rz{ai} do appear in some nonstandard dialects.} However, if the verb takes some other agreement suffix, as in (\ref{ex:mixed_agreement}), then direct evidence agreement is used. This is most common for the reflexive.

\begin{example} \label{ex:mixed_agreement}
	\script hes a Ąksi lattá.
	\bits hes a\tsbs{i} ąk-s\tsbs{j}-i\tsbs{i} lattá\tsbs{j}
...
The perfective construction uses \rz{ot} and demotes the semantic verb to adjunct with the preposition \rz{tę}.
