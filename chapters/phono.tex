...
The nasal sibilant /n͡z/ is a typologically odd segment. The prototypical transcription of this sound is [z̃], a voiced fricative with simultaneous nasal release; however, phonetic research\marginnote{See \href{https://www.icacommission.org/Proceedings/ICA1998Seattle/pdfs/vol_4/2921_1.pdf}{Ohala et al. (1998)} for further discussion of nasal fricatives.} suggests that true fricatives cannot be fully nasalized. Thus, this segment's typical realization may be better represented as a slightly fricated approximant [\tsps{n}z̞̃]. Speakers of Frontier Standard often realize it simply as [z], with inconsistent prenasalization. % or a fully nasalized approximant [\tsps{n}ɹ̃].
...
\section{Stress}
 Stress typically falls on the penultimate syllable of a word. Atypical vowel stress, most common in loan words and compounds, is marked with an acute. \marginnote[*-1]{For example, \rz{kemu} “fruit slice” is predictable, but \rz{meatrę́} “limb” has atypical final stress and is marked.}

\paragraph{Productivity} Stress is lexically productive. On a phonetic level, most minimal pairs further differ because of reduction. For example, \rz{rasrę́} [rəsˈreː] “netting” and \rz{resrą} [ˈrɛsrəː] “owl” have different surface vowels, but share the phonemic segments /rɛsreː/.
...
\paragraph{Secondary stress} Secondary stress falls on alternating syllables starting from primary stress and spreading left. For example, \rz{kagęsa} “army” has regular stress on the penultimate syllable, but when inflected in plural form, it surfaces as \rz{kegąsazr} [ˌkɛ.gəːˈsaː.z̃ɹ]. Secondary stress prevents the reduction of low vowels to schwa, but, unlike primary stress, does not cause length or VOT increase.
