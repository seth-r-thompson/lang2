...
\entry[pos=verb tr.]{akral}{\sense give \sense[refl.] hold, own \sense leads to, correlates with }
...
\entry[pos=noun]{emassoi}{\sense boss \sense[sports] coach, manager \sense[\rz{emassoi kąstezi}] on-field coach \sense[\rz{emassoi ǫkas}] general manager }
...
\entry[pos=noun,sound=/hórǫ̆kăs/,etym=\rz{hor} + \rz{ǫks}]{hórąks}{\sense mathematics }
\entry[pos=verb tr.]{husal}{\sense shout at }
\entry[pos=noun,etym=\rz{husal} + -\rz{eks}]{husaleks}{\sense[ntr.] fame \sense[adj.] famous }
...
\entry[pos=noun,etym=\rz{sapa} + \rz{-r}]{sapr}{\sense fur }
...
\entry[pos=noun]{sia}{\sense sand \sense[name] a female given name }
